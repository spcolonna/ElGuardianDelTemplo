...
class TextosUi {
  ...
  static const _es = <String, String>{
    ...
    'dif.granMaestro': 'Gran Maestro',
    'dif.granMaestroSub': 'La primera vez que el cuerpo pasa factura.',
    'dif.ancianoDelTemplo': 'Anciano del Templo',
    'dif.ancianoDelTemploSub':
        'Ya no alcanza con aguantar: hay que administrar.',
    ...
    'tienda.caminos': 'Los ocho caminos',
  ...
  static const _en = <String, String>{
    ...
    'dif.granMaestro': 'Grand Master',
    'dif.granMaestroSub': 'The first time your body sends the bill.',
    'dif.ancianoDelTemplo': 'Elder of the Temple',
    'dif.ancianoDelTemploSub': 'Enduring is no longer enough: now you manage.',
    ...
    'tienda.caminos': 'All eight paths',
